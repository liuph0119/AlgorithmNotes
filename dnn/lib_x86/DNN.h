...
DNN_API bool DNNTraining(NNDataLayer &datalayer_training, NNDataLayer &datalayer_validation,
	vector<NNFullyConnectLayer> &vFullyConnectList, vector<NNSigmoidLayer> &vSigmoidList,
	NNQuadraticLoss &losslayer, Accuracy &accuracy,
	double dLearningRate = 1.0, int nEpoch = 100, double max_acc = 0.99, bool bEpochConstraint = true, char* sLogFn = "log.csv");

DNN_API bool saveModel(vector<NNFullyConnectLayer> &vFC, const char* fn);

DNN_API bool loadModel(vector<NNFullyConnectLayer> &vFC, const char* fn);
